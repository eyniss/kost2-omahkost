...
$kost = [
    ...
    'listrik' => true,
    'fasilitas_kamar' => ['Kasur Double Bed', 'Bantal', 'Meja', 'Kursi', 'Lemari Baju', 'Ventilasi', 'Kamar Mandi Dalam'],
...
<div class="container">
    ...
    <div class="gambar">
        <img src="http://localhost/kost2/assets/img/typeb.png" alt="Omah Kost Tipe B" class="gambar-utama">
