...
$kost = [
    ...
    'listrik' => true,
    'fasilitas_kamar' => ['Kasur Double Bed', 'Bantal', 'Meja', 'Kursi', 'Lemari Baju', 'Ventilasi', 'Kamar Mandi Luar'],
...
<div class="container">
    ...
    <div class="gambar">
        <img src="http://localhost/kost2/assets/img/typea.png" alt="Omah Kost Tipe C" class="gambar-utama">
